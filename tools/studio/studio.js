(function () {
  ...
  function blankProject(name = "Untitled project") {
    return { id: uid("project"), name, goal: "", createdAt: Date.now(), updatedAt: Date.now(), datasets: [], activeDatasetId: null, steps: [], rules: [], report: null, schedules: [], customTools: [], connections: [], members: [], comments: [], versions: [], activities: [{ text: "Project created", at: nowLabel() }], runs: [], mappings: [], joins: [], glossary: [], metrics: [], contracts: [], anomalies: [], privacyFindings: [], approvals: [], dashboardPlans: [], analystPlans: [], cleaningSuggestions: [], changeHistory: [], stories: [], reportDesigns: [], chatMessages: [], chatChannels: [{ id: "general", name: "General" }, { id: "analysis", name: "Analysis" }, { id: "quality", name: "Data quality" }, { id: "decisions", name: "Decisions" }], tasks: [], decisions: [], issues: [], annotations: [], canvasItems: [], notifications: [], alertRules: [], deliveries: [], dataRequests: [], forms: [], formSubmissions: [], branches: [], auditEvents: [], agentReviews: [], meetings: [], knowledgeBase: [], metricRegistry: [], portalAssets: [], installedConnectors: [], savedViews: [], evidenceThreads: [], datasetBriefings: [], collaborationConfig: null, projectStatus: "Draft", readiness: null, learningMode: false, branding: null };
  }

  function normalizeProject(project) {
    for (const key of ["datasets", "steps", "rules", "schedules", "customTools", "connections", "members", "comments", "versions", "activities", "runs", "mappings", "joins", "glossary", "metrics", "contracts", "anomalies", "privacyFindings", "approvals", "dashboardPlans", "analystPlans", "cleaningSuggestions", "changeHistory", "stories", "reportDesigns", "chatMessages", "chatChannels", "tasks", "decisions", "issues", "annotations", "canvasItems", "notifications", "alertRules", "deliveries", "dataRequests", "forms", "formSubmissions", "branches", "auditEvents", "agentReviews", "meetings", "knowledgeBase", "metricRegistry", "portalAssets", "installedConnectors", "savedViews", "evidenceThreads", "datasetBriefings"]) if (!Array.isArray(project[key])) project[key] = [];
    if (!project.name) project.name = "Untitled project";
    if (!project.projectStatus) project.projectStatus = "Draft";
    if (!project.chatChannels.length) project.chatChannels = [{ id: "general", name: "General" }, { id: "analysis", name: "Analysis" }, { id: "quality", name: "Data quality" }, { id: "decisions", name: "Decisions" }];
    return project;
  }
